...
(This is probably a good time to get up and take a break before comming back in a bit)
...
to whatever you like, I'd recommend making it sevrige for when the logo is added to fastfetch

26. Linux kernel (hey there, if you're here, I just want to say you're doing amazing right now, this is also a good time to get up for a bit before continuing, thanks for using sevitge) now, where were we.
...
28. fstab (you're almost there, KEEP GOING)
...
29. Final self-hosting pass

The target now contains:

GCC,Binutils,Glibc,GNU userspace,systemdD-Bus,PAM,Shadow,Linux,Linux-firmware,GRUB
...
Disable temporary swap if necessary and reboot, (congrats, you have officially downloaded sevrige, you can configure more components like desktop environments yourself or wait for the second guide "Suomi" to release, hope you enjoyed installing sevrige as I enjoyed making it!)
